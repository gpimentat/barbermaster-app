                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="bg-gray-900 rounded-lg p-4 border border-gray-700">
                                                        ...
                                                        <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                                                            <p className="text-blue-400 text-[10px] font-medium flex items-start gap-2">
                                                                <Star size={14} className="flex-shrink-0 mt-0.5" />
                                                                <span>
                                                                    <strong>Recomendado:</strong> Use Cloudflare (grátis) para ter SSL (HTTPS) no seu domínio. Sem SSL, navegadores mostrarão aviso "Não seguro".
                                                                </span>
                                                            </p>
                                                        </div>
                                                    </div>
